...
export const translations = {
  en: {
    ...
    experienceIntro: "I've spent the past years building a strong foundation in software development and system architecture. My journey blends engineering rigor with creative exploration, evolving from core programming principles to scalable, full-stack systems and thoughtfully designed digital experience.",
    education: "Education",
    ...
    coreTech: "CORE TECH",
    systemsLogic: "SYSTEMS & LOGIC",
    dataInfra: "DATA & INFRA",
    creativeSimulation: "CREATIVE / SIMULATION",
  ...
  es: {
    ...
    experienceIntro: "He pasado los últimos años construyendo una base sólida en desarrollo de software y arquitectura de sistemas. Mi camino combina rigor ingenieril con exploración creativa, evolucionando desde principios fundamentales de programación hasta sistemas full-stack escalables y experiencias digitales cuidadosamente diseñadas.",
    education: "Educación",
    ...
    // Tech Stack Categories
    coreTech: "TECNOLOGÍAS PRINCIPALES",
    systemsLogic: "SISTEMAS Y LÓGICA",
    dataInfra: "DATOS E INFRAESTRUCTURA",
    creativeSimulation: "CREATIVO / SIMULACIÓN",
  ...
  fr: {
    ...
    experienceIntro: "J'ai passé ces dernières années à construire une base solide en développement logiciel et architecture de systèmes. Mon parcours mêle rigueur technique et exploration créative, évoluant des principes fondamentaux de programmation vers des systèmes full-stack évolutifs et des expériences numériques soigneusement conçues.",
    education: "Éducation",
    degree: "Ingénierie en Sciences Informatiques",
    ...
    // Tech Stack Categories
    coreTech: "TECHNOLOGIES PRINCIPALES",
    systemsLogic: "SYSTÈMES ET LOGIQUE",
    dataInfra: "DONNÉES ET INFRA",
    creativeSimulation: "CRÉATIF / SIMULATION",
  ...
  de: {
    ...
    experienceIntro: "Ich habe die letzten Jahre damit verbracht, eine solide Grundlage in Softwareentwicklung und Systemarchitektur aufzubauen. Meine Reise verbindet technische Präzision mit kreativer Erkundung und entwickelt sich von grundlegenden Programmierprinzipien zu skalierbaren Full-Stack-Systemen und durchdacht gestalteten digitalen Erlebnissen.",
    education: "Bildung",
    degree: "Ingenieurwesen in Informatikwissenschaften",
    ...
    // Tech Stack Categories
    coreTech: "KERNTECHNOLOGIEN",
    systemsLogic: "SYSTEME & LOGIK",
    dataInfra: "DATEN & INFRASTRUKTUR",
    creativeSimulation: "KREATIV / SIMULATION",
