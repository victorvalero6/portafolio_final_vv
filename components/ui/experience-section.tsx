...
function ExperienceCard({ experience, index, totalCards }: { experience: Experience; index: number; totalCards: number }) {
  ...
  return (
    <div
      className={cn(
        "group relative flex flex-col gap-3 rounded-xl border border-white/10 bg-black/40 p-4 sm:p-6 backdrop-blur-md transition-all duration-300 shadow-2xl",
        "hover:-translate-y-1 hover:border-white/20 hover:bg-black/50 hover:shadow-[0_0_30px_-5px_rgba(255,255,255,0.1)]"
      )}
    >
