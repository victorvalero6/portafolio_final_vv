...
export function SkillsSection({
  ...
  const skills = useMemo<Skill[]>(
    () => [
      ...
      { name: "Swift", detail: "iOS, SwiftUI, UIKit", level: 90, icon: Layers },
      { name: "SQL", detail: "PostgreSQL, Architecture", level: 85, icon: Database },
      { name: "Software Architecture", detail: "Systems design, patterns", level: 85, icon: Terminal },
      { name: "C#", detail: ".NET, Unity Game Dev", level: 78, icon: Layout },
      { name: "Java", detail: "SpringBoot, Systems", level: 72, icon: Cpu },
      { name: "Docker", detail: "Containerization, CI/CD", level: 70, icon: Server },
    ],
    []
  )
